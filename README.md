...
- `assets/docs/` : exemples de fiches techniques et FDS téléchargeables.

## Utilisation
Ouvrir `index.html` ou `blog.html` dans un navigateur moderne. Aucun build requis.
